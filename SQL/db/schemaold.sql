...
CREATE TABLE `messages` (
  ...
  PRIMARY KEY (`id_message`, `id_user_from`, `id_room`)
);
...
ALTER TABLE `friendships` ADD FOREIGN KEY (id_user_from) REFERENCES `users` (`id_user`);
ALTER TABLE `friendships` ADD FOREIGN KEY (id_user_to) REFERENCES `users` (`id_user`);
...
-- ('','');
-- INSERT INTO `friendships` (`id_user_from`,`id_user_to`) VALUES
-- ('','');
